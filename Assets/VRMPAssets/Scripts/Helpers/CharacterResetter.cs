...
namespace XRMultiplayer
{
    public class CharacterResetter : MonoBehaviour
    {
        ...
        [SerializeField] Vector3 basePosition = new Vector3(0, .5f, -12.0f);
        ...
        [ContextMenu("Reset player to base position")]
        void ResetPlayerPosition()
        {
            ResetPlayer(basePosition);
        }
    }
}
